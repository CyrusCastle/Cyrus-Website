...
object URLDisguiser {
    private val disguises = mapOf(
        "${getHost()}/composeResources/cyruswebsite.composeapp.generated.resources/files/404" to "Page: Error",
        "${getHost()}/composeResources/cyruswebsite.composeapp.generated.resources/files/browser" to "https://engine.com",
        "${getHost()}/composeResources/cyruswebsite.composeapp.generated.resources/files/cawl" to "https://cawlfyth.ol"
    )
